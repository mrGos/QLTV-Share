...
Public Class LoaiSachDAL
    ...
    Public Function update_Loaisach(ls As LoaiSachDTO) As Integer
        Dim query As String = String.Empty
        ...
        Using conn As New SqlConnection(connectionString)
            Using comm As New SqlCommand()
                With comm
                    ...
                    .CommandType = CommandType.Text
                    .CommandText = query
                    .Parameters.AddWithValue("@maloaisach", ls.MaLoai)
                    .Parameters.AddWithValue("@tenloaisach", ls.TenLoai)
                End With
                Try
                    conn.Open()
                    comm.ExecuteNonQuery()
