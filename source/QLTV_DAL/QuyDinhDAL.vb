...
Public Class QuyDinhDAL
    ...
    Public Function selectQuyDinh(ByRef quydinh As QuyDinhDTO) As Result
        ...
        query &= "SELECT [tuoitoithieu],[tuoitoida],[thoigiansudung], [khoangnamxuatban],[sosachmuontoida],[songaymuontoida] "
            ...
            Using comm As New SqlCommand()
                ...
                Try
                    ...
                    If reader.HasRows = True Then
                        While reader.Read()
                            quydinh = New QuyDinhDTO(reader("tuoitoithieu"), reader("tuoitoida"), reader("thoigiansudung"), reader("khoangnamxuatban"), reader("sosachmuontoida"), reader("songaymuontoida"))
                        End While
                    End If
    ...
    Public Function update(qd As QuyDinhDTO) As Result
        ...
        query &= " ,thoigiansudung = @thoihang"
        query &= " ,[khoangnamxuatban] = @khoangnamxuatban "
        query &= " ,[sosachmuontoida] = @soluongsachtoida "
        ...
        Using conn As New SqlConnection(connectionString)
            Using comm As New SqlCommand()
                With comm
                    ...
                    .Parameters.AddWithValue("@thoihang", qd.thoiHang)
