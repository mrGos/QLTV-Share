Public Class QuyDinhDTO
    ...
    Public Sub New(iTuoiToiThieu As Integer, iTuoiToiDa As Integer, ThoiHang As Integer, iKhoangNamXuatBan As Integer, iSoLuongSachToiDa As Integer, iSoNgayMuonToiDa As Integer)
        Me.iTuoiToiThieu = iTuoiToiThieu
        Me.iTuoiToiDa = iTuoiToiDa
        Me.iThoiHang = ThoiHang
    ...
    Public Property thoiHang As Integer
        Get
            Return iThoiHang
        End Get
        Set(value As Integer)
